    ...
    return (
        <div className="flex flex-col gap-5 md:gap-10">
            ...
            <nav className="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-40">
                ...
                <ContainerListSlide className="flex justify-center items-center gap-2 md:gap-10 overflow-x-auto no-scrollbar shadow-inner">
                    {linkTo.map((i, idx) => {
                        ...
                        return (
                            <ItemListSlideUp key={idx} >
                                ...
                                className={`
                                    relative p-4 text-[10px] md:text-sm font-medium cursor-pointer whitespace-nowrap transition-all duration-300
                        ...
                        <div className="flex gap-5 md:gap-12 flex-col md:flex-row md:items-center">
                            <div className="space-y-6 max-w-lg">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20">
                                    ...
                                    <p className="text-[6px] md:text-[10px] uppercase tracking-[0.3em] font-bold text-[#D4AF37]">Flash Sale 48h</p>
                                </div>

                                <div className="space-y-3">
                                    <h2 className="text-lg md:text-5xl font-black text-white tracking-tighter leading-tight">
                                        Ưu đãi <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">độc quyền</span> <br /> 
                                        cho hội viên
                                    </h2>
                                    <p className="text-[sm] md:text-xl text-slate-400 font-medium leading-relaxed">
                                ...
                                <ScrollInViewRight>
                                    <NavLink 
                                        to="/product/hoivien" 
                                        className="inline-flex items-center gap-1 md:gap-3 px-4 py-2 md:px-8 md:py-4 bg-red-800 text-white rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-red-950 hover:shadow-[0_20px_40px_-10px_rgba(255,255,255,0.2)] transition-all duration-500 group/btn"
                                    >
                                        Xem thêm
